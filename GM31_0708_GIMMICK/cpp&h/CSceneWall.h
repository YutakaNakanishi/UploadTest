//=============================================================================
//
// メッシュ壁の処理 [CSceneWall.h]
// Author : yutaka nakanishi
//
// 2014/5/21
//=============================================================================
#ifndef _CSCENEWALL_H_
#define _CSCENEWALL_H_
//=============================================================================
//インクルード
//=============================================================================
#include "CScene.h"
...
class CSceneWall:public CScene
{
	public:
		//引数コンストラクタ
		CSceneWall(int nPriority,OBJTYPE Type);
		//デストラクタ
		~CSceneWall();
		//純粋仮想関数用
		...
		//オブジェクト生成
		static CSceneWall*			Create(CRenderer *pRenderer,int nNumBlockX, int nNumBlockZ, float fSizeBlockX, float fSizeBlockZ,D3DXVECTOR3 Pos,D3DXVECTOR3 Rot,char* filename,OBJTYPE Type);
	private:
